...
## Послесловие
Возможно описанный мной метод выше  не идеален, и содержит ошибки и неточности, однако цель данной статьи не сделать конечный продукт, а грубо говоря дать пищи для размышления,а может настало время списать со счетов телевиденье и переключится на другие источники информации? Возможно, имея браузер и полноценный Linux подтянутый к телевизору появляется возможность выбирать что смотреть ? Заодно можно объединить приятное с полезным, например изучать английский или программирование? 
